...
- [x] สร้างฐานข้อมูลยา
- [x] ข้อมูล: ชื่อยา, ประเภท, ราคา, จำนวนคงเหลือ
- [x] เพิ่ม/แก้ไข/ลบยา
- **Commit message**: `feat: create medicine database`

### Day 30: Medicine Stock Management ✅
- [x] แสดงจำนวนคงเหลือ (Stock Transaction System)
- [x] แจ้งเตือนเมื่อยาใกล้หมด (Low Stock Alert Dashboard)
- [x] ประวัติการเบิกยา (Transaction History)
- [x] ระบบเบิก/รับยา (Stock In/Out Modal)
- [x] รายการยาที่ต้องสั่งซื้อ (Reorder List)
- [x] Integration with Dashboard
- **Commit message**: `feat: implement medicine stock tracking (Day 30)`
